...
var grokOgIdentity = { "site": {
	"title": "L'Atelier de la Séduction",
	"card": "custom",
	"description": "Lingerie de luxe à Abidjan — pièces rares, confection raffinée.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_1ldgJj = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_1ldgJj
	};
	return ((_m, p) => {
		return {
			data,

...
import { g as colors, h as colorLabel, m as categoryLabel, r as Route$3 } from "./router-nc0T7Vaq.mjs";
import { t as ProductCard } from "./ProductCard-YmXmawj1.mjs";
import { t as WhatsAppCta } from "./WhatsAppCta-ik7abKK7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/produit._slug-BQtqz4jN.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function ProductPage() {
	const { product, related } = Route$3.useLoaderData();
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					product.videos.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-4 space-y-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-[11px] tracking-[0.16em] uppercase text-muted",
							children: "En vidéo"
						}), product.videos.map((src, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("video", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("source", { src }), "Votre navigateur ne supporte pas la lecture de vidéos."]
							})
						}, src))]
					}) : null
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {

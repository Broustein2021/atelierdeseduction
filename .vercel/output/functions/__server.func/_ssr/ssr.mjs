...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BoxQyy2O.mjs");
...
var manifest = {
	"7a1d53344a389af93085ddff6b42a66c92115fd2e84fca70296e8361cbfdbf7e": {
		functionName: "getProducts_createServerFn_handler",
		importer: () => import("./products-server-Cupd6YeX.mjs")
	},
	"7c68d60e1faa96a6f30f9bae02c86b57422fefba9842d59443a7e38930cc4994": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-nc0T7Vaq.mjs").then((n) => n.t),
